<template>
  <div class="card mt-2">
    <div class="card-header fw-bold bg-transparent">
      ...
      <div class="fw-normal text-muted">Profil dan Password</div>
    </div>

    <div class="card-body">
      <ul class="nav nav-tabs fw-bold" role="tablist">
        <li class="nav-item" role="presentation">
          <a class="nav-link active" data-bs-toggle="tab" href="#profil" aria-selected="true" role="tab">Profil</a>
        </li>
      ...
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane active show pt-3" id="profil" role="tabpanel">
