...
async function fetchData() {
  ...
  let res = await client.collection('aset').getOne(route.params.id, {
    expand: "tahun_pengadaan, sumber_aset, unit_kerja, rincian_aset, satuan_aset"
  })
...
async function handleEdit() {
  ...
  let res = await client.collection('aset').update(route.params.id, form.value)
